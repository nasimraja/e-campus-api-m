...
var courseRecording = function(courseRecording) {
...
courseRecording.createNewcourse_recordings = (data, result) => {
    dbConn.query('INSERT INTO course_recordings SET ? ', data, (err, res) => {
        if (err) {
            result(err ,null);
        } else {
            result(null, res)
...
module.exports = courseRecording