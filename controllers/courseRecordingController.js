const courseRecording = require('../models/courseRecordingModel')
const dbConn = require('../dbConnection');


// course recording list
exports.courserecordinglist = (req, resp) => {
    dbConn.query("select * from course_recordings", (err, courserecordinglist) => {
        if(err)
        throw new Error(err)
